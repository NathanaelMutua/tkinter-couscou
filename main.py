...
def enter_data():
    ...
    if accepted == "Accepted":
        ...
        if firstname and lastname:
            ...
            filepath = r"C:\Users\user\Documents\CODE\PYTHON\Data Entry Form\data.xlsx"
...
nationality_combobox = ttk.Combobox(user_info_frame, values=["Africa", "Antarctica", "Australia", "Asia", "North America", "Europe", "South America"])
...
numsemesters_spinbox = tkinter.Spinbox(courses_frame, from_= 0, to =70)
